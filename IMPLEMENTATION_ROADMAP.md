...
| 2.5 | donation_failed.html erstellen         | `donation_failed.html` (neu)            | Erledigt: freundliche Fehlermeldung + Retry   |
...
| 3.4 | Stripe failed-Payment            | `routers/payments.py`      | Erledigt: `payment_intent.payment_failed` Handler + Mail        |
