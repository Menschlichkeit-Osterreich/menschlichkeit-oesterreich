    ...
    >
      ...
      <div className="relative flex h-full flex-col justify-between p-6">
        <div className="flex items-start justify-between gap-4">
          <div className="rounded-2xl bg-accent-950 p-4" style={{ backgroundColor: '#050d14' }}>
            <span className="inline-flex rounded-full border border-white/20 bg-accent-800 px-3 py-1 text-[11px] font-semibold uppercase tracking-[0.18em] text-white">
              Babylon.js Preview
            </span>
            <h3 className="mt-4 text-2xl font-black text-white" style={{ color: '#ffffff' }}>Brücken Bauen in 3D</h3>
            <p className="mt-2 inline-block max-w-sm rounded-xl bg-accent-950 px-3 py-2 text-sm leading-6 text-white" style={{ backgroundColor: '#050d14' }}>
        ...
        <div className="space-y-4">
          <div className="flex flex-wrap gap-2">
            {THEMENWELTEN.map((welt) => (
              <span
                key={welt}
                className="rounded-full border border-white/20 bg-accent-800 px-3 py-1 text-xs font-medium text-white"
              >
                {welt}
              </span>
            ))}
          ...
          <div className="rounded-xl bg-accent-950 px-3 py-2" style={{ backgroundColor: '#050d14' }}>
            ...
            <div className="h-2 overflow-hidden rounded-full bg-accent-800">
              <div
