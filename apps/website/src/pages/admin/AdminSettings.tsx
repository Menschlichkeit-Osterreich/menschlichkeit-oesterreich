          ...
          {activeTab === 'verein' && (
            <div className="space-y-5">
              ...
              {[
                ...
                { label: 'ZVR-Zahl', value: '1234567890', type: 'text' },
                { label: 'Gründungsjahr', value: '2020', type: 'number' },
                { label: 'Vereinssitz', value: 'Wien', type: 'text' },
                { label: 'Straße & Hausnummer', value: 'Musterstraße 1', type: 'text' },
                { label: 'PLZ', value: '1010', type: 'text' },
