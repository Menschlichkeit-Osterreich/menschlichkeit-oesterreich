      ...
      <div className="space-y-8 text-gray-700 leading-relaxed">
        ...
        <section id="verarbeitung">
          ...
          <p>
            ...
            Erfüllung unserer Vereinstätigkeit erforderlich ist. Dies umfasst:
          </p>
          <ul className="list-disc list-inside mt-3 space-y-2">
            <li>Mitgliedschaftsdaten (Name, Adresse, E-Mail) für die Verwaltung der Mitgliedschaft</li>
        ...
        <section>
          ...
          <ul className="list-disc list-inside mt-3 space-y-2">
            ...
            <li>Art. 6 Abs. 1 lit. c DSGVO (rechtliche Verpflichtung) – bei steuerrelevanten Daten</li>
            <li>Art. 6 Abs. 1 lit. f DSGVO (berechtigte Interessen) – für die Website-Sicherheit</li>
          </ul>
        </section>
        ...
        <section>
          ...
          <p>
            ...
            Mitgliedsdaten werden nach Beendigung der Mitgliedschaft gelöscht, sofern
            keine steuerlichen oder rechtlichen Gründe einer Löschung entgegenstehen.
          </p>
        </section>
        ...
        <section>
          ...
          <address className="not-italic mt-3">
            ...
            1030 Wien<br />
            <a href="https://www.dsb.gv.at" className="text-primary-600 hover:underline" target="_blank" rel="noopener noreferrer">
              www.dsb.gv.at
            </a>
          </address>
        </section>
