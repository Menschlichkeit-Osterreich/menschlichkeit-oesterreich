...
def create_auth_dependencies():
    ...
    try:
        ...
        security = HTTPBearer()
        from ...app.secrets_provider import get_secret as _get_secret
        SECRET_KEY = _get_secret("JWT_SECRET_KEY", bsm_key="api/JWT_SECRET_KEY") or _get_secret("JWT_SECRET", bsm_key="api/JWT_SECRET")
