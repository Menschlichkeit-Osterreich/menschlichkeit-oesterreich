"""Bitwarden Secrets Manager Provider fuer OpenClaw Agent-Runtime.

Identische Logik wie openclaw-system/api/fastapi_gateway/secrets_provider.py,
angepasst fuer den Agent-Runtime Deployment-Kontext.
        ...
        settings = client_settings_from_dict(
            {
                ...
                "userAgent": "openclaw-agent-runtime/2.0",
            }
        )
