...
**Original Request**: 
> "figma.com/make/***REDACTED***/Website?node-id=0-1&t=SqSpfnaEvWGr5H80-1 ruf das design mit figma mcp server ab und integriere"
...
- Extracts design metadata from Figma file `***REDACTED***`
