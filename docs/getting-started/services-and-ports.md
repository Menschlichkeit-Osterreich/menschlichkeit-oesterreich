...
| OpenClaw Agent-Runtime | 9100 | `bash openclaw-system/scripts/boot.sh` | `openclaw-system/` |
| OpenClaw Tool-Gateway | 9101 | `bash openclaw-system/scripts/boot.sh` | `openclaw-system/` |
| NATS JetStream | 4222 | (via boot.sh) | `openclaw-system/` |
| Qdrant | 6333 | (via boot.sh) | `openclaw-system/` |
| Windows-Bridge | 18790 | Windows: Install-OpenClawBridge.ps1 | `openclaw-system/windows-bridge/` |
