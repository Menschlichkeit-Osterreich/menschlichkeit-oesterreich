...
| `BW_ACCESS_TOKEN` / `BSM_ACCESS_TOKEN`           | workflow    | Zugriff des In-Job-Secret-Loaders auf Bitwarden Secrets Manager                         | GitHub Environment oder Repo Secret mit dokumentierter Ausnahme         | `.github/actions/bsm-env-inject/action.yml`                | DevOps           | DevOps            | nur Zugriff fuer benoetigtes BSM-Service-Account-/Projekt-Scope                  | 90 Tage oder bei Exposure sofort                                                    | Ausnahme von der BSM-first-Regel; keine Secret-Outputs zwischen Jobs                                                   |
