...
### 7. New Issue – Security: Harden Content Security Policy
   ...
   File: `api.menschlichkeit-oesterreich.at/app/middleware/security.py` lines 119–120
   Body:
...
### 8. New Issue – Privacy/DSGVO: Implement JWT Token Revocation on Account Deletion
   ...
   File: `api.menschlichkeit-oesterreich.at/app/routes/privacy.py` line 304
   Body:
...
### 9. New Issue – Privacy/DSGVO: Complete PostgreSQL Cascade Deletion
   ...
   File: `api.menschlichkeit-oesterreich.at/app/routes/privacy.py` line 255–263
   Body:
...
### 11. New Issue – API: Register security router in main.py
    ...
    File: `api.menschlichkeit-oesterreich.at/app/routers/security.py`
    Body:
...
### 13. New Issue – Metrics: CiviCRM integration for dashboard endpoints
    ...
    File: `api.menschlichkeit-oesterreich.at/app/routers/metrics.py`
    Body:
...
### 16. New Issue – Game: Implement settings screen
    ...
    File: `apps/game/v2/js/main.js` line 87
    Body:
