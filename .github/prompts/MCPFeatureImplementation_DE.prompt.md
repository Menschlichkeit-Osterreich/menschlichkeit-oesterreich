...
migrationTarget: .github/chatmodes/development/MCPAPIDesign_DE.chatmode.md
...
> **DEPRECATED** — Migriert nach `.github/chatmodes/development/MCPAPIDesign_DE.chatmode.md`. Diese Datei bleibt nur als Referenz erhalten.
