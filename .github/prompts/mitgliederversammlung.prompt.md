...
migrationTarget: .github/prompts/Vereinsplattform.prompt.md
category: verein
tags: ['verein']
version: '1.0.0'
language: de-AT
...
> **DEPRECATED** — Migriert nach `.github/prompts/Vereinsplattform.prompt.md`. Diese Datei bleibt nur als Referenz erhalten.
