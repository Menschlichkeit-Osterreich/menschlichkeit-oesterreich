...
| Infrastructure | 3      | Build-Pipeline, Deployment, Mail-Archiv                  |
...
| 18  | openclaw-bridge.json                        | OpenClaw Bridge         | Legacy (nicht im aktiven Kernscope) | Webhook           | Legacy/Archivhinweis  | Bearer-Auth          |
...
- IP-Whitelisting fuer interne Webhooks (Plesk) pruefen
...
| Workflow                       | CiviCRM | Stripe | PostgreSQL | Slack | Email | Social APIs | GitHub | Plesk |
| ------------------------------ | ------- | ------ | ---------- | ----- | ----- | ----------- | ------ | ----- |
