...
| 7 | Kein "Spende fehlgeschlagen"-Template/Flow | **P1** | Neues Template + Webhook |
...
| Fehlerhafte Spenden ohne Benachrichtigung an Spender | **Mittel** | Vertrauensverlust bei Spendern | Failed-Payment-Template erstellen und Stripe-Failed-Handler implementieren |
...
6. **Stripe-Failed-Handler** implementieren mit neuem `donation_failed`-Template
